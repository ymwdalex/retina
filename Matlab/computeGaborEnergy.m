function [result oriensMatrix data] = computeGaborEnergy(img, lambda, aspectratio, bandwidth, orientation, shift, halfwave, supPhases, inhibition, fastmode, thinning, threshold)
    oriensMatrix = [];
